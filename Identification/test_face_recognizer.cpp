...
std::string MODEL_DIR = "D:/technology/SeetaFaceEngine-master/FaceDetection/model/";
#else
std::string DATA_DIR = "./data/";
std::string MODEL_DIR = "./model/";
#endif
void TEST(FaceRecognizerTest, CropFace) {
	//seeta_fd_frontal_v1.0.bin seeta_fr_v1.0.bin
  //FaceIdentification face_recognizer((MODEL_DIR + "seeta_fr_v1.0.bin").c_str());
  FaceIdentification face_recognizer(nullptr);
