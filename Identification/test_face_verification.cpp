...
#ifdef _WIN32
std::string DATA_DIR = "D:/technology/SeetaFaceEngine-master/FaceIdentification/data/";
std::string MODEL_DIR = "D:/technology/SeetaFaceEngine-master/FaceIdentification/model/";
#else
...
int main(int argc, char* argv[]) {
  ...
  seeta::FaceDetection detector("D:/technology/SeetaFaceEngine-master/FaceDetection/model/seeta_fd_frontal_v1.0.bin");
  ...
  seeta::FaceAlignment point_detector("D:/technology/SeetaFaceEngine-master/FaceAlignment/model/seeta_fa_v1.1.bin");
